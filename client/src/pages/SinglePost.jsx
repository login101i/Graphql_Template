...
function SinglePost(props) {
    //? props id potrzebne aby otrzymać postId 
  const postId = props.match.params.postId;
  const { user } = useContext(AuthContext);
  const commentInputRef = useRef(null);
//? używamy div i ref bo w semantic UI nie możemy zrobić ref
  ...
  const [submitComment] = useMutation(SUBMIT_COMMENT_MUTATION, {
    ...
    //? poniżej wysyłamy to co zapisaliśmy w submit_comment_mutation na samym dole 
    variables: {
      postId,
      body: comment,
    },
